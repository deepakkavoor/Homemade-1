...
public class DinnerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Spinner spinner3 = (Spinner) findViewById(R.id.dinner_drinks_spinner);
        ArrayAdapter<CharSequence> adapter3 = ArrayAdapter.createFromResource(this,
                R.array.food_array,  android.R.layout.simple_spinner_item);
        adapter3.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner3.setAdapter(adapter3);

        final EditText spinner3_quantity = (EditText) findViewById(R.id.dinner_drinks_spinner_quantity);


        final EditText additional_menu = (EditText) findViewById(R.id.additional_dinner);
        ...
        dinner_upload = findViewById(R.id.dinner_upload);

        dinner_upload.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                menu_item.put("menu_type", "Dinner");
